$(document).ready(function () {
        ...
        $('.ui-app-bar-buttons').click(function(){
            alert("helloi")
        })
        ...
        //do a count on the amount of times the section class appears 
        //create an array of that and then toggle between them?
        //need to fix that bug where you go over scroll and it stops working
        
        function nextSection()
        {
            if( next === undefined)
                {
                    next = $('.metro-section').next();
                }
                else
                    {
                        if(prev === undefined)
