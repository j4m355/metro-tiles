$(document).ready(function () {
        ...
        {
            if( next === undefined){next = $('.metro-section').next();}else{if(prev === undefined){next = next.next();}else{next = prev.next();prev = undefined}}
            return next;
        }

        function previousSection()
        {
            if (prev === undefined) {if (next === undefined) {prev = $('.post').prev();}else{prev = next.prev();}}else{prev = prev.prev();}
            return prev;
        }
